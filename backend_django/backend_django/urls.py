...
urlpatterns = [
    ...
    path('absensi-sholat/', TemplateView.as_view(template_name='absensi-sholat.html'), name='absensi-sholat'),
    ...
    path('pertemuan-pengasuhan/', TemplateView.as_view(template_name='pertemuan-pengasuhan.html')),
