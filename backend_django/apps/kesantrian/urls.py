...
urlpatterns = [
    ...
    path('hafalan/template-csv/', views.download_hafalan_record_template, name='hafalan-template-csv'),
    path('hafalan/import-csv/', views.import_hafalan_record_csv, name='hafalan-import-csv'),
